...
if __name__ == '__main__':
    ...
    parser.add_argument('remote_repo_url', nargs='?', default="https://github.com/helloworlder8/Lightglue.git", help="The URL of the remote Git repository. Default is 'https://github.com/helloworlder8/transformers.git'")
